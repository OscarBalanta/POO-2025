public class Descuento {
    ...
    public Descuento(String codigo, String descripcion, int cantidad, double precioUnitario) {
        // Validar código
    ...
    public static void main(String[] args) {
        ...
        Descuento p1 = new Descuento();
        System.out.println(p1);

        System.out.println("\n=== Producto parametrizado ===");
        Descuento p2 = new Descuento("A123", "Mouse inalámbrico", 3, 25000);
